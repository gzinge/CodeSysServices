...
class TaskManagerControllerTest {
    ...
    void testGetAllTask() throws Exception {
        ...
        taskList.add(new Task(1L, "Task 1", "Description 1", "user1", Date.from(Instant.now())));
        taskList.add(new Task(2L, "Task 2", "Description 2", "user1",Date.from(Instant.now())));
    ...
    void testGetTaskByTitle() throws Exception {
        ...
        when(taskManagerService.getTaskByTitle("Task 1")).thenReturn(task);
    ...
    void testCreateTask() throws Exception {
        Task task = new Task(1L, "Task 1", "Description 1", "user1",Date.from(Instant.now()));
